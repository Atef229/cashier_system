...
onChange(e) {
  ...
  this.props.history.push('/all-orders/'+"?Created_start=" + moment(this.state.Created_start).format('MM/DD/YYYY')+'&Created_end='+moment(this.state.Created_end).format('MM/DD/YYYY'));
